...
async def start(event):
  await event.reply("**🌀Newtaggerbot**\n ile Grubunuzdakı Tüm Üyelere Etiket Ata bilirim \nKomutlar için 👉 /help yazın**",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/newtagger_bot?startgroup=a')],
                      [Button.url('Serseri🙋‍♂️bio', 'https://t.me/serseribio')],
                      [Button.url('Resmi Grup📣', 'https://t.me/SohbetimPanoroya')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/Serserikaptan')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🌀 NewTaggerbot Komutları**\n\n**/tag <Nedeni> - 5-li Etiket Atar**\n\n**/etag <Nedeni> - Emoji ile etiketler**\n\n**/tektag nedeni - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', 'https://t.me/newtagger_bot?startgroup=a')],
                      [Button.url('Serseri bio👨‍💻', 'https://t.me/serseribio')],
                      [Button.url('Resmi Grup🔖', 'https://t.me/SohbetimPanoroya')],
		      [Button.url('Developer🧑‍🔧', 'https://t.me/serserikaptan')],
                    ),
                    link_preview=False
...
print(">> Bot çalıyor merak etme 🚀 @serserikaptan bilgi alabilirsin <<")
